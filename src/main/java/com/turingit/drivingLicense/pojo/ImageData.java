...
@TableName(autoResultMap = true, value = "imageData2",schema = "public")
@Data
...
public class ImageData {
    ...
    private Integer typeid;       //类型代号
    private Date checktime;       //处理时间
    private Integer abnormalImage; //0、未处理；1、处理完成；2、识别不全；3、图片有误；4、系统找不到指定的路径；5、图片无法识别
